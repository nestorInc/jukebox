...
%ajaxmin% -analyze tab/tabs.js ^
	-global:Class,Element,HTML5Storage ^
	1>NUL 2>>%log%
%ajaxmin% -analyze tab/search.js ^
	-global:$R,Class,Control,Tab,TableKit,Draggable,Element,genres,FormatTime,SortUnique,Template ^
	1>NUL 2>>%log%%
%ajaxmin% -analyze tab/upload.js ^
	-global:JSON,qq,Class,Tab,TableKit,MusicFieldEditor,Notifications,genres,genresOrdered,Template,Element ^
	1>NUL 2>>%log%%
%ajaxmin% -analyze tab/debug.js ^
	-global:Class,Tab,JsonPrettyPrint ^
	1>NUL 2>>%log%%
%ajaxmin% -analyze tab/account.js ^
	-global:Class,Tab ^
	1>NUL 2>>%log%%
...
%ajaxmin% -analyze tab/notification.js ^
	...
	1>NUL 2>>%log%%
%ajaxmin% -analyze tab/playlist.js ^
	-global:Element,Notifications,Class,Tab ^
	1>NUL 2>>%log%%

%ajaxmin% -analyze genres.js 1>NUL 2>>%log%
%ajaxmin% -analyze storage.js 1>NUL 2>>%log%
...
%ajaxmin% -analyze jukebox.js ^
	-global:Query,Ajax,Extend,Notifications,Action,JukeboxUI,soundManager,JSON,$R,HTML5Storage ^
	1>NUL 2>>%log%%
%ajaxmin% -analyze jukeboxUI.js ^
	-global:$,$R,Control,Extend,Event,Element,Droppables,Draggable,Tabs,SearchTab,UploadTab,DebugTab,NotificationTab,CustomQueriesTab,FormatTime,genresOrdered,HTML5Storage,Template,Notifications,PlaylistTab ^
	1>NUL 2>>%log%%

:: Analyze the concatenated file generated by gruntjs
%ajaxmin% -analyze ../../html/js/jukebox.js ^
	-global:Ajax,Notifications,soundManager,$,$R,Effect,Element,Event,JSON,Draggable,Droppables,Control,Class,TableKit,qq,Template,Tabs,UploadTab,DebugTab,NotificationTab,CustomQueriesTab,PlaylistTab,SearchTab ^
	1>NUL 2>>%log%%
