...
var notificationTab = Class.create(Tab, {
    ...
    updateContent : function( ){
        ...
        notification_display += '<h1>Notification sender</h1>';
        notification_display += '<input type="button" value="test notification debug" onclick="showNotification(1,\'Notification notification notification\');" />';
        notification_display += '<input type="button" value="test notification info" onclick="showNotification(2,\'Notification notification notification\');" />';
        notification_display += '<input type="button" value="test notification warning" onclick="showNotification(3,\'Notification notification notification\');" />';
        notification_display += '<input type="button" value="test notification error" onclick="showNotification(4,\'Notification notification notification\');" />';
        notification_display += '<input type="button" value="test notification fatal" onclick="showNotification(5,\'Notification notification notification\');" />';
